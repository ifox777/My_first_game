...
class Scores():
    """""Вывод игоровой информации"""
    def __init__(self, screen, stats):
        """"инициализирум подсчет очкоы"""
        self.screen = screen
    ...
    def image_score(self):
        """"Преобразовывает текст счета в гарфическое изображение"""
    ...
    def image_high_score(self):
        """преобразует рекород в графическое изображение"""
